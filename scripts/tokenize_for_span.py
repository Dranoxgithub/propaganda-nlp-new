...
pickle.dump(df, open(f'../processed_data/{train_or_dev}_{context_length}_span_new.pkl', "wb"))
df.to_csv(f'../processed_data/{train_or_dev}_{context_length}_span_new.csv', index = False)