...
def run():
    ...
    parser.add_argument("--model_name", dest="model_name", help="name of model to use") # choices=["base", "hier"]
    ...
    sys.path.append("./models/climate_change_data")

    # models
    import roberta_cc_base, roberta_cc_hier
    ...
    if args.model_name == 'base':
        columns_to_keep = ['tokens', 'combined_label', 'paragraph_index']
    else:
        columns_to_keep = ['tokens', 'label', 'sublabel', 'paragraph_index']
    ...
    if args.model_name == 'base':
        ...
        dataset = dataset.rename_column("combined_label", "label")
        roberta_cc_base.train( \
