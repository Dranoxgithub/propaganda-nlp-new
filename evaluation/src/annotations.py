...
import evaluation.src.article_annotations as aa
...
#        pass
    ...
    def compute_TC_score(self, second_annotations:Annotations):
        ...
        if an.Annotation.propaganda_techniques is not None:
            ...
            precision_per_class = precision_score(gold_labels, submission_labels, average=None, labels=propaganda_techniques_list)
            recall_per_class = recall_score(gold_labels, submission_labels, average=None, labels=propaganda_techniques_list)
            # change - anni
            return precision, recall, f1, f1_per_class, precision_per_class, recall_per_class
    ...
    def TC_score_to_string(self, second_annotation:Annotations, output_for_script=False):
            ...
            if an.Annotation.propaganda_techniques is None: #raise an error
                ...
                # change - anni
                precision, recall, f1, f1_per_class, precision_per_class, recall_per_class  = self.compute_TC_score(second_annotation)
                ...
                if output_for_script:
                    ...
                    res_for_script = ""
                    # change - anni
            return res_for_screen, res_for_script, f1, precision, recall, f1_per_class, precision_per_class, recall_per_class
